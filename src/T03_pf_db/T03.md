...
- Files
  ...
  - 💾 `./_entrypoint/init.sql` [(link)](https://github.com/fullstack-68/pf-db/blob/main/_entrypoint/init.sql)
...
- Any SQL files in `_entrypoint` will be executed automatically, when a docker container is created.
  ![width:800px](./img/docker_entrypoint.png)
...
- Files
  ...
  - 💾 `./.npmrc` [(Link)](https://github.com/fullstack-68/pf-db/blob/main/.npmrc)
